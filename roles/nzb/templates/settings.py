...
# Searcharr Bot
searcharr_password = "{{ vault_nzb_searcharr_password }}"  # Used to authenticate as a regular user to add series/movies
searcharr_admin_password = "{{ vault_nzb_searcharr_admin_password }}"  # Used to authenticate as admin to manage users
searcharr_language = "de-de"  # yml file in the lang folder
searcharr_start_command_aliases = ["start"]  # Override /start command
searcharr_help_command_aliases = ["help", "hilfe"]  # Override /help command
searcharr_users_command_aliases = ["users"]  # Override /users command

# Telegram
tgram_token = "{{ vault_nzb_searcharr_telegram_token }}"

# Sonarr
sonarr_enabled = True
sonarr_url = "http://sonarr:8989"  # http://192.168.0.100:8989
sonarr_api_key = "{{ vault_nzb_searcharr_sonarr_api_key }}"
sonarr_quality_profile_id = ["HD-1080p", "HD-1080p - German"]  # can be name or id value - include multiple to allow the user to choose
...
radarr_api_key = "{{ vault_nzb_searcharr_radarr_api_key }}"
radarr_quality_profile_id = ["HD-1080p", "HD-1080p - German"]  # can be name or id value - include multiple to allow the user to choose
